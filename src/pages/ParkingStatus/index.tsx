import { IonPage, IonHeader, IonToolbar, IonButtons, IonMenuButton, IonTitle, IonContent, IonGrid, IonRow, IonLabel, IonCard, IonList, IonItem, IonCol, IonInput, IonText, isPlatform } from "@ionic/react"
                            ...
                            <IonCard class="ion-padding" style={{ width: '100%' }}>
                                ...
                                <IonRow class="ion-justify-content-center">
                                    <IonList style={{ width: '100%' }}>
                                        <IonItem>
                                            <IonCol size="4">
                                                <IonText style={styles.sideText}>Locacion</IonText>
                                            </IonCol>
                                            <IonCol size="4">
                                                <IonText style={styles.sideText}>Usados/Total</IonText>
                                            </IonCol>
                                            <IonCol size="4">
                                                <IonText style={styles.sideText}>Estado</IonText>
                                            </IonCol>
                                        </IonItem>
                                        {results?.map((locacion, index) => (
                                            <IonItem key={index}>
                                                <IonCol size="4">
                                                    <IonText style={styles.sideText}>{locacion.title}</IonText>
                                                </IonCol>
                                                <IonCol size="4">
                                                    <IonText style={styles.sideText}>{locacion.used}/{locacion.total}</IonText>
                                                </IonCol>
                                                <IonCol size="4">
                                                    <IonCard style={{ 
                                                        width: 15, 
