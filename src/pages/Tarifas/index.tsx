                                ...
                                <IonRow class="ion-justify-content-center">
                                    <IonList style={{ width: '100%' }}>
                                        ...
                                        {results?.map((locacion, index) => (
                                            <IonItem key={index}>
                                                <IonCol size="6">
                                                    <IonText>{locacion.title}</IonText>
                                                </IonCol>
                                                <IonCol size="6">
                                                    <IonList>
                                                        <IonText style={styles.sideText}>cada 1 hora $ {locacion.tarifa}</IonText>
                                                        <IonText style={styles.sideText}>$0 los primeros 30 minutos</IonText>
                                                    </IonList>
                                                </IonCol>
                                            </IonItem>
                                        ))}
